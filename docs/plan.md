...
| T12 | #51 | Add Timeline Scene input img2img source image support | Agent Timeline MVP | Ready | TBD | Product PASS | Adds root Timeline source-image upload, img2img denoise default/editing, forced single-image generation, and shared ComfyUI txt2img workflow support for default/Illustrious plus Anima VAEEncode. GitHub Issue required before implementation. |
