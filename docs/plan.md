...
Create the GitHub Issue for `T4`, the initial input and vertical timeline shell. The LangGraph workflow orchestration foundation is complete and merged in PR #8.
