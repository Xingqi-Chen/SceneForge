...
| T34 | #125 | Add Story Graph planning diagnostics and retry guard | Story Graph Refinement | Done | PASS | APPROVE | Categorized local LLM logs, Story planning request/response/error log context, no same-pass auto-run for errored workflow nodes, and Story prompt stability refinements. Closes Issue #125. |
