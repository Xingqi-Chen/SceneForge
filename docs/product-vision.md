...
The MVP supports one primary character in the 3D canvas. Multi-character composition, sequence generation, inpainting, ControlNet, and upscaling are later work.
