...
const linkClassName =
  "inline-flex h-9 items-center justify-center gap-2 rounded-md border border-slate-200 bg-white px-3 text-xs font-medium text-slate-700 shadow-sm transition-colors hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-400";
  ...
  return (
    <main className="sf-app-shell flex min-h-0 flex-col overflow-hidden bg-slate-50 font-sans text-slate-950 selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="flex min-h-0 flex-1 items-center justify-center p-4">
        <div className="w-full max-w-md rounded-md border border-slate-200 bg-white p-5 text-sm leading-relaxed text-slate-600 shadow-sm">
