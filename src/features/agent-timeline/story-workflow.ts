...
export const storyWorkflowEdges = [
  ...
  { from: "story-bible", to: "entity-cards" },
  { from: "storyboard-shots", to: "entity-cards" },
  { from: "character-continuity-graph", to: "entity-cards" },
  { from: "storyboard-shots", to: "reference-asset-plan" },
  { from: "entity-cards", to: "reference-asset-plan" },
  ...
  { from: "entity-cards", to: "story-render-plan" },
  { from: "reference-asset-plan", to: "story-render-plan" },
  ...
  { from: "entity-cards", to: "story-consistency-check" },
  { from: "reference-asset-plan", to: "story-consistency-check" },
  ...
  { from: "reference-asset-plan", to: "generation-gate" },
...
export const storyWorkflowDefinition = {
  ...
  metadata: {
    ...
    "entity-cards": createStoryNodeMetadata({
      aiLabel: "Suggest entities",
      editLabel: "Edit entity cards",
      inputKind: "json",
      nodeId: "entity-cards",
      title: "Entity cards",
    }),
    "reference-asset-plan": createStoryNodeMetadata({
      aiLabel: "Plan references",
      editLabel: "Edit reference assets",
      inputKind: "json",
      nodeId: "reference-asset-plan",
      title: "Reference asset plan",
    }),
...
export function validateStoryWorkflowDefinition(
  ...
  const requiredPredecessors: Array<[StoryWorkflowNodeId, StoryWorkflowNodeId]> = [
    ...
    ["entity-cards", "character-continuity-graph"],
    ["reference-asset-plan", "entity-cards"],
    ["story-render-plan", "entity-cards"],
    ["story-render-plan", "reference-asset-plan"],
    ["generation-gate", "reference-asset-plan"],
