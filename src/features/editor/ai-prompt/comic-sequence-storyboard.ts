  ...
  return [
    {
      ...
      content: [
        ...
        "Split the user's complete action paragraph into sequential shot prompts.",
        shotCountInstruction,
        "Return JSON only. Do not wrap it in markdown.",
        "Schema: { \"shots\": [{ \"title\"?: string, \"prompt\": string }] }.",
        "Each prompt must be an English Stable Diffusion / cinematic shot prompt.",
        "Focus each prompt on local action, camera framing, pose, expression, gesture, motion, and immediate setting.",
